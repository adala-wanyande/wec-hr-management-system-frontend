...
//Dummy state
let contractDetails = {
  "scanOfSignedContract": "scan.pdf"
}


const ViewEmployeeContractDetailsSubPage3 = () => {
  return (    
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <Link to="../employee/contract" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Employee Contract Details Dashboard</Link>
              </div>
            </li>
      ...
      <div className="flex justify-center mt-8">
        <ul class="sm:w-[640px] text-sm font-medium shadow-md text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
          <div className='grid grid-cols-2 divide-x w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600'>
            ...
            <li class="px-8 py-2 text-left">{contractDetails.scanOfSignedContract}</li>
          </div>
        </ul>
      </div>
