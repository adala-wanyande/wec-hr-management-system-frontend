...
import EmployeeDetailsDashboardButton from '../Components/EmployeeDetailsDashboardButton';
  ...
  return (
    <div>
      ...
      <div className="mx-4 p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <PageTitle title="Employee Details Dashboard"></PageTitle>     
        <div class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900 p-4 m-4 grid grid-cols-2 gap-4">
          <EmployeeDetailsDashboardButton className="shadow-md" buttonText="View Your Employee Bio Data Details" link="bio-data"></EmployeeDetailsDashboardButton>
          <EmployeeDetailsDashboardButton className="shadow-md" buttonText="View Your Employee Next of Kin Details" link="next-of-kin"></EmployeeDetailsDashboardButton>
