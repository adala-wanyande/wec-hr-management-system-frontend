            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <p class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">View Employee Contract Details Dashboard</p>
                </div>
              </li>
            </ol>
          </nav>
...
export default ViewEmployeeContractDetailsDashboard