...
import CreateEmployeeBioDataDetailsSubpage1 from '../SubPages/CreateEmployeeBioDataDetailsSubpage1'
import CreateEmployeeBioDataDetailsSubpage2 from '../SubPages/CreateEmployeeBioDataDetailsSubpage2'
import CreateEmployeeBioDataDetailsSubpage3 from '../SubPages/CreateEmployeeBioDataDetailsSubpage3'
import CreateEmployeeBioDataDetailsSubpage4 from '../SubPages/CreateEmployeeBioDataDetailsSubpage4'
...
const CreateEmployeeBioDataDetailsPage = () => {
  ...
  return (
    <>
        ...
        <SuccessAlert successMessage="You have successfully created new employee bio data details for Employee ID: 8801"></SuccessAlert>
      </div>
    </>
  )
}
